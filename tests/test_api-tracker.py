...
class MaintenanceTrackerApiTest(unittest.TestCase):
    ...
    #     """                       
    #     resource = self.client().post('/maintenanceTrackerApp/api/v1/users/',data=json.dumps(self.register_user),
    ...
    def test_user_signin(self):
        ...
        """                       
        resource = self.client().post('/maintenanceTrackerApp/api/v1/users/login',data=json.dumps(self.register_user),
                                        content_type='application/json')
    ...
    #     """
    #     resource = self.client().post('/maintenanceTrackerApp/api/v1/requests', data=self.request)
    #     self.assertEqual(resource.status_code,201)
